...
function MainContent() { 
    return (
        <>
                ...
                <p>Please report bugs to <a href="mailto:lwk19@comp.nus.edu.sg?cc=dominic_bryan@u.nus.edu&subject=ROJIKU Bug Report" target="_blank" rel="noreferrer noopener" >lwk19@comp.nus.edu.sg</a> and attach a screenshot of the problem.</p>
        </>
    )
}